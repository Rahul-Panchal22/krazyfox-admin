...
import { masterTrans, PaymentPendingListing } from "../../actions/Payment";


const Mastertransactionlist = () => {
  ...
  const getAllCampaignListing = () => {
    ...
    dispatch(masterTrans(`?campaignId=${localStorage.getItem("campaignId")}`))
      .then((res) => {
        console.log("res--------------", res);
...
export default Mastertransactionlist;
